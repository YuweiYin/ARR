...
echo -e "\n\n >>> python3 run_eval_lm.py --use_arr --eval_task_name ${EVAL_TASK_NAME} --hf_id ${MODEL}"
OUTPUT_DIR="results/eval_results-temp_${GEN_TEMP}-${NUM_FEW_SHOT}-shot--arr_${ARR_ABLATION}/"  # ${MODEL_NAME} is subdir
mkdir -p "${OUTPUT_DIR}"
